...
export declare function buildProvenance(request: ArtifactSearchRequestV1, profiles: readonly ArtifactProfileV1[], resolution: ArtifactProfileResolution): ArtifactExecutionProvenanceV1;
