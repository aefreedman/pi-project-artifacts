...
export function registerProjectArtifactLegacyReferencesV1(scope: object): Readonly<{ token: RegistrationToken; unregister(): boolean }> {
  const allowed = new Set<string>(PROJECT_ARTIFACT_LEGACY_PATHS_V1);
